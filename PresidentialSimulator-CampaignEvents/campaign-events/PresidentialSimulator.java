...
/** Application entry point. Gameplay is entirely in GameEngine. */
public final class PresidentialSimulator {
    public static void main(String[] args) {
        long seed = System.nanoTime();
        boolean gui = true, color = false;
        Path save = Path.of("saves", "campaign.save");
        try {
    ...
    private static void usage() {
        System.out.println("Presidential Simulator - Campaign Events Edition");
