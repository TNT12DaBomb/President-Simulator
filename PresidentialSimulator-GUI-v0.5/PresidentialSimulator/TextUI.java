        ...
        try { while(true){
            ...
            switch(topic){
                ...
                case 2 -> {
                    ...
                    text("Debates arrive on turns 4, 8 and 12. Each starts with preparation, then three factual exchanges, a policy tradeoff and a record follow-up. Live answers take 8–12 seconds; challenges give six seconds to recover.");
