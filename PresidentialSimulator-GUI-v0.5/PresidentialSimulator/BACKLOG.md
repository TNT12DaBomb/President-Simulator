...
Not delivered: the new protocol does not alter candidate ratings, campaign finances or electoral support. Old authored debate scoring is not invoked for current careers. Opponent styles are scripted behaviors, not numerical personality assessments. A transcript is not yet a fully executable governing promise.
