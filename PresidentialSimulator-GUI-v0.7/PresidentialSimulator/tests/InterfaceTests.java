...
public final class InterfaceTests {
 ...
 public static void main(String[]args)throws Exception{
  ...
  try{
   ...
   e=debate();e.submit(CareerCommand.campaign(GameCommand.respond(1)));e.submit(CareerCommand.campaign(GameCommand.tick(27)));CareerSave.write(e,save);
