...
public final class PresidentialSimulator {
    public static void main(String[] args) {
        long seed=System.nanoTime(); boolean gui=false, color=true, screen=System.console()!=null;
        ...
        try {
            for(int i=0;i<args.length;i++)switch(args[i]){
                case "--seed" -> seed=Long.parseLong(args[++i]);case "--save" -> save=Path.of(args[++i]);
    ...
    private static void usage(){
        ...
        System.out.println("--seed <integer>   --save <file>   --gui | --no-gui   --help");
