...
import javax.swing.*;
/** Nonblocking live window. Hiding retains the decision and its normal deadline. */
public final class DebateWindow {
 ...
 public void pauseAndHide(){if(window!=null)window.setVisible(false);}
 public void open(){
  ...
  if(window==null){Window parent=SwingUtilities.getWindowAncestor(owner);if(parent==null)return;
   window=new JDialog(parent,"Presidential Simulator — Live debate",Dialog.ModalityType.MODELESS);window.setDefaultCloseOperation(JDialog.DO_NOTHING_ON_CLOSE);
