...
public record CampaignEvent(String id, String title, String description, Category category,
    ...
    public enum Kind { FUNDS, COMPLETE_TASK, REMOVE_TASK, ACTION_COST, FUNDRAISING, SUPPORT }
    public record Effect(Side side, Kind kind, int amount, State.Task task, int duration) {
        public Effect {
            ...
            boolean timed = kind == Kind.ACTION_COST || kind == Kind.FUNDRAISING || kind == Kind.SUPPORT;
