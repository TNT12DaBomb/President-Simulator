...
public final class DesktopController {
    ...
    public void start(long seed, President.Difficulty difficulty, President.RunningMate mate) {
        if(busy)return;
        engine=new CareerEngine(seed,difficulty,mate); messages=List.of("Your campaign begins. You are the BLUE campaign; the opponent is RED. Visit Map to choose where to work. Each campaign action uses one turn.");
