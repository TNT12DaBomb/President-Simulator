...
public final class PracticeDebatePanel extends JPanel {
    ...
    public PracticeDebatePanel(long seed,DebateSettings settings){
        this.settings=settings;debate=new LiveDebate("practice",0,new ArrayList<>(),settings);setLayout(new BorderLayout());setBorder(javax.swing.BorderFactory.createCompoundBorder(javax.swing.BorderFactory.createLineBorder(DeskStyle.LEATHER,8),new javax.swing.border.EmptyBorder(8,8,8,8)));
    ...
    private void render(){
        ...
        JScrollPane scroll=new JScrollPane(sheet);scroll.setBorder(null);scroll.getViewport().setBackground(DesktopPanel.CARD);scroll.getVerticalScrollBar().setUnitIncrement(24);add(scroll);DeskStyle.paper(this);revalidate();repaint();
    }
}
